(function (f) {
    ...
    return (function e(t, n, r) {
        ...
        "./freeze/freeze_with_spinner.js": [function (require, module, exports) {
            /**
        ...
        }, {"../dom": 3, "../event_manager": 4}],
        "./listen/listen_by_selectors.js": [function (require, module, exports) {
            /**
             * Author: Jeff Whelpley
             * Date: 6/2/15
             *
...
// it out during testing and easily reset it as necessary
            ...
            function done() {
                ...
                if (opts.buffer) {
                    bufferManager.switchBuffer(opts);
                }  // switch from server to client buffer
                if (opts.freeze) {
                    state.freeze.cleanup();
...
// only expose start
        ...
        }, {"./buffer/buffer_manager": 2, "./dom": 3, "./event_manager": 4, "./log": 1}]
    }, {}, [5])(5)
});
...
preboot.init({
    ...
    "listen": [{
        "name": "selectors",
        "eventsBySelector": {"input[type=\"text\"],textarea": ["keypress", "keyup", "keydown"]}
    }, {
        "name": "selectors",
        "eventsBySelector": {"input[type=\"text\"],textarea": ["focusin", "focusout"]},
        "trackFocus": true,
        "doNotReplay": true
    }, {
        "name": "selectors",
        "preventDefault": true,
        "eventsBySelector": {"input[type=\"submit\"],button": ["click"]},
        "dispatchEvent": "PrebootFreeze"
    }],
    "freezeStyles": {
        "overlay": {
        ...
        "spinner": {
            ...
            "style": {"position": "absolute", "display": "none", "zIndex": "99999999"}
        }
    }
});
